...
import {Body, Box, Button, Colors, Dialog, Heading, Spinner} from '@dagster-io/ui';
    ...
    >
      ...
      >
        <Box flex={{direction: 'column', gap: 8, alignItems: 'start', justifyContent: 'start'}}>
          <Heading>Bem-vindo ao Dagster</Heading>
          <Body style={{color: Colors.Gray700, marginBottom: '4px'}}>
            Conecte-se com milhares de outros profissionais de dados que criam com o Dagster.
            compartilhar conhecimento, obtenha ajuda e contribua com o projeto de código aberto.
          </Body>
        </Box>
