...
export const SidebarAssetInfo: React.FC<{
  ...
  return (
    <>
      ...
      {(asset.description || OpMetadataPlugin?.SidebarComponent || !hasAssetMetadata) && (
        <SidebarSection title="Descrição">
          <Box padding={{vertical: 16, horizontal: 24}}>
            <Description description={asset.description || 'Nenhuma descrição fornecida'} />
          </Box>
      ...
      {asset.opVersion && (
        <SidebarSection title="Versão do código ">
          <Box padding={{vertical: 16, horizontal: 24}}>
      ...
      {assetConfigSchema && (
        <SidebarSection title="Configuração">
          <Box padding={{vertical: 16, horizontal: 24}}>
            <ConfigTypeSchema
      ...
      {asset.requiredResources.length > 0 && (
        <SidebarSection title="Recursos necessários">
          <Box padding={{vertical: 16, horizontal: 24}}>
