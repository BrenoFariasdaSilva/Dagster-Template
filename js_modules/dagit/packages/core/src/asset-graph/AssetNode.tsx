    ...
    return {
      ...
      content: (
        <>
          ...
          <span style={{flex: 1}} color={Colors.Gray800}>
            {numMaterializing === 1
              ? `Materializando 1 partição...`
              : numMaterializing
              ? `Materializando ${numMaterializing} partição...`
              : `Materializando...`}
          </span>
          {expanded && <SpacerDot />}
    ...
    return {
      ...
      content: (
        <>
          ...
          <span style={{color: Colors.Yellow700}}>Nunca se materializou</span>
        </>
      ),
    };
  }
  ...
  return {
    ...
    content: (
      <>
        ...
        <span style={{color: Colors.Green700}}>Materializado</span>
        {expanded && <SpacerDot />}
        {lastMaterializationLink}
      </>
    ),
