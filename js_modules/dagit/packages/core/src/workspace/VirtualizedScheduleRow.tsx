...
export const VirtualizedScheduleHeader = (props: {checkbox: React.ReactNode}) => {
  ...
  return (
    ...
    >
      ...
      <HeaderCell>Nome do agendamento</HeaderCell>
      <HeaderCell>Agendar</HeaderCell>
      <HeaderCell>Executando</HeaderCell>
      <HeaderCell>Última marcação</HeaderCell>
      <HeaderCell>Última execução</HeaderCell>
