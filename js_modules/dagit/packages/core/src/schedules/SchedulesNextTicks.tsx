  ...
  if (!nextTicks.length) {
    return (
      <Box padding={{vertical: 32}}>
        <NonIdealState
          icon="error"
          title="Não existe cargas programadas"
          description={
            anySchedules ? (
              <>
              ...
              <>
                Não existem agendas neste espaço de trabalho. Crie um calendário em execução para ver os seus tiques programados.
              </>
            )
          }
          action={
...
const NextTickMenuItems: React.FC<{
  ...
  if (evaluationResult.error) {
    return <MenuItem text="Visualizar erro..." onClick={() => onItemOpen(true)} />;
  }
