...
export const AssetGroupRoot: React.FC<{repoAddress: RepoAddress; tab: 'lineage' | 'list'}> = ({
  ...
  useDocumentTitle(`Grupo de ativos: ${groupName}`);
      ...
      <PageHeader
        ...
        right={
          <div style={{marginBottom: -8}}>
            <ReloadAllButton label="Recarregar definições" />
          </div>
        }
        ...
        tabs={
          ...
          >
            <Tabs selectedTabId={tab}>
              <TabLink id="lineage" title="Linhagem" to={`${groupPath}/lineage`} />
              <TabLink id="list" title="Lista" to={`${groupPath}/list`} />
            </Tabs>
  ...
  return (
    <>
      <Tag icon="asset_group">
        Grupo de ativos em  <RepositoryLink repoAddress={repoAddress} />
      </Tag>
