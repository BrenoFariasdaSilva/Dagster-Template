        ...
        >
          ...
          >
            {assetNode.description ? (
              ...
              <Body>Nenhuma descrição fornecida</Body>
            )}
          </Box>
          {assetNode.opVersion && (
            <>
              ...
              >
                <Subheading>Versão do código</Subheading>
              </Box>
          ...
          {assetNode.freshnessPolicy && (
            <>
              <Box
                ...
                border={{side: 'horizontal', width: 1, color: Colors.KeylineGray}}
              >
                <Subheading>Política de atualização</Subheading>
              </Box>
              <Box
                padding={{vertical: 16, horizontal: 24}}
          ...
          {assetNode.autoMaterializePolicy && (
            <>
              <Box
                ...
                border={{side: 'horizontal', width: 1, color: Colors.KeylineGray}}
              >
                <Subheading>Política de materialização automática</Subheading>
              </Box>
              <Box
                padding={{vertical: 16, horizontal: 24}}
                flex={{gap: 12, alignItems: 'flex-start'}}
          ...
          >
            <Subheading>
              Conjunto de ativos{upstream?.length ? ` (${upstream.length})` : ''}
            </Subheading>
            <Link to="?view=lineage&lineageScope=upstream">
              <Box flex={{gap: 4, alignItems: 'center'}}>
                Visualizar conjunto de gráficos
          ...
          >
            <Subheading>
              Jusante de ativos{downstream?.length ? ` (${downstream.length})` : ''}
            </Subheading>
        ...
        >
          <>
            <Box
              ...
              border={{side: 'bottom', width: 1, color: Colors.KeylineGray}}
            >
              <Subheading>Recursos necessários</Subheading>
            </Box>
            <Box
              padding={{vertical: 16, horizontal: 24}}
              border={{side: 'bottom', width: 1, color: Colors.KeylineGray}}
            >
              ...
              {assetNode.requiredResources.length === 0 && (
                <Body>
                  Não são necessários recursos para apresentar
                  <Box padding={{top: 4}}>
          ...
          <>
            <Box
              ...
              border={{side: 'bottom', width: 1, color: Colors.KeylineGray}}
            >
              <Subheading>Configuração</Subheading>
            </Box>
            <Box
              padding={{vertical: 16, horizontal: 24}}
              border={{side: 'bottom', width: 1, color: Colors.KeylineGray}}
            >
              {assetConfigSchema ? (
                ...
                <Body>
                  Nenhum esquema de configuração definido
                  <Box padding={{top: 4}}>
          ...
          <>
            ...
            {assetType && assetType.displayName !== 'Any' ? (
              ...
              <Box padding={{vertical: 16, horizontal: 24}}>
                <Body>
                  Nenhum dado de tipo de entrada e saída definido
                  <Box padding={{top: 4}}>
                    <a href="https://docs.dagster.io/concepts/types#overview">Visualizar documentação</a>
                  </Box>
                </Body>
              </Box>
            )}
          ...
          <>
            <Box
              ...
              flex={{justifyContent: 'space-between', gap: 8}}
            >
              <Subheading>Metadados</Subheading>
            </Box>
            <Box style={{flex: 1}}>
              {assetMetadata.length > 0 ? (
                ...
                <Box padding={{vertical: 16, horizontal: 24}}>
                  <Body>
                    Nenhum metadado de definição de recurso definido
                    <Box padding={{top: 4}}>
