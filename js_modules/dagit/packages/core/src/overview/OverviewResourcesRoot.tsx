...
export const OverviewResourcesRoot = () => {
  useTrackPageView();
  useDocumentTitle('Visão Geral | Recursos');
      ...
      return (
        <Box padding={{top: 20}}>
          <NonIdealState
            ...
            description={
              anyReposHidden
                ? 'Não foram encontrados recursos nos locais de código seleccionados'
                : 'Não foram encontrados recursos nas suas definições'
            }
          />
        </Box>
      );
  ...
  return (
    <Box flex={{direction: 'column'}} style={{height: '100%', overflow: 'hidden'}}>
      <PageHeader
        title={<Heading>Recursos</Heading>}
